...
## Attributes
	...
	category0.removeChild # Remove child categories
	...
	category0.setFunc() # Set a function to be executed when the callFunc() method is called
	category0.callFunc() # Calls the function defined by the setFunc() function
...
## Attributes
	...
	childcategory0.removeChild # Remove child categories
